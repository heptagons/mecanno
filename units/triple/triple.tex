...
\begin{scope}[shift={(0,0)}] %row-1 col-1
\draw[black,fill=black](0,0)
 -- node[below]{13} ++(13,0) circle(5pt)
 -- node[right]{5} ++(5*\x,5*\y) circle(5pt)
 -- node[right]{8} ++(8*\x,8*\y) circle(5pt)
 -- node[right]{8} ++(-8*\x,8*\y) circle(5pt)
 -- node[right]{5} ++(-5*\x,5*\y) circle(5pt)
 -- node[above]{13} ++(-13,0) circle(5pt)
 -- node[left]{2} ++(-2*\x,-2*\y) circle(5pt)
 -- node[left]{11} ++(-11*\x,-11*\y) circle(5pt)
 -- node[left]{11} ++(+11*\x,-11*\y) circle(5pt)
 -- node[left]{2} ++(2*\x, -2*\y) circle(5pt);
\draw[blue] (-2*\x,+2*\y) 
 -- node[left]{11} ++(11*\x,11*\y) circle(5pt)
 -- node[left]{11} ++(-11*\x,11*\y);
\draw[red] (13+5*\x,5*\y) 
 -- node[below]{13} (9*\x,13*\y)
 -- node[above]{13} (13+5*\x,21*\y);
\end{scope}
