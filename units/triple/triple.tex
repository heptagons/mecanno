...
\draw[black,fill=black] (O) node[below]{$O$}
 ...
 -- node[below]{$\ca$} (JJ) circle(5pt)
 -- node[below,blue]{$\cb$} (H) circle(5pt)
 (J)
 -- node[left,red]{$#3$} (I) node[left]{$I$} circle(5pt)
 -- node[below]{$\ca$} (II) circle(5pt)
 -- node[left,red]{$#3$} (JJ) circle(5pt)
 (II)
 -- node[below,blue]{$\cb$} (III) circle(5pt)
 -- (L)
 ;
...
\begin{scope}[scale=0.12]
 ...
 \end{scope}
 \begin{scope}[shift={(70,0)}] %row-1 col-1
  \decagonTriple{6}{3}{20}{18}{31}
 \end{scope}
\end{scope}
\end{tikzpicture}
\caption{Decagons with $e=31$}
\label{fig:decagons} 
\end{figure}
...
\begin{scope}[scale=0.08]
 ...
 \end{scope}
 \begin{scope}[shift={(0,-100)}] %row-1 col-1
  \decagonTriple{8}{12}{51}{36}{71}
 \end{scope}
\end{scope}
\end{tikzpicture}
\caption{Decagons with $e=71$}
\label{fig:decagons} 
\end{figure}
