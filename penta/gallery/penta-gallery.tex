...
\caption{Pentagon of size 7 with 6 internal strips. $\overline{FC} : \overline{CD} = 6:7$. $\overline{FD} = 4 + 3\sqrt5$.}
\label{fig:penta7-6a}
\end{figure}
...
\subsection{Size 8 with 10 internal strips}

\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{8/penta8-10a}
...
Our software found few solutions. The cluster $DEBGF$ shown in the figure hardly fit inside the pentagon. We calculate angles around vertice $E$ $\alpha = \angle{DEF}$ with the law of cosines and $\beta = \angle{BEG}$ whitin the isoscelles triangle $\triangle{BEG}$:
\begin{align}
...
\begin{figure}[h]
 ...
 \caption{Pentagon size 12 with 6 internal strips. $\overline{AE}:\overline{ED}:\overline{DC} = 12:12:12$ and $\overline{AC} = 6 + 6\sqrt5$}.
