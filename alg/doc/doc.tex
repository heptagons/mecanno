...
\subsection{New $B_1 \mapsto B$}
\begin{align}
B1 &= \frac{\pm b_1}{a_1}\\
 &= \frac{\pm b}{a} \implies \{ \pm b, a \} = \gcd\{ \pm b_1, a_1 \}
\end{align}

\subsection{Add $B_1 + B_2 \mapsto B$}
\begin{align}
B_1 + B_2 &= \frac{\pm b_1}{a_1} + \frac{\pm b_2}{a_2} \\
 &= \frac{\pm b_1a_2 \pm b_2a_1 }{a_1a_2} \\
 &= \frac{\pm b}{a} \implies (\pm b, a) = \gcd(\pm b_1a_2 \pm b_2a_1, a_1a_2)
\end{align}

\subsection{Mul $B_1 \times B_2 \mapsto B$}
\begin{align}
B_1 \times B_2 &= \frac{\pm b_1}{a_1} \times \frac{\pm b_2}{a_2} \\
  &= \frac{\pm b_1b_2}{a_1a_2} \\
  &= \frac{\pm b}{a} \implies (\pm b,a) = \gcd(\pm b_1b_2, a_1a_2)
\end{align}

\subsection{Inv $1 / B_1 \mapsto B \iff a_1 > 0$}
\begin{align}
\frac{1}{B_1} &= \frac{1}{\pm b_1 / a_1}\\
 &= \frac{\pm a_1}{b_1} \\
 &= \frac{\pm b}{a} \implies \{ b \} = a_1, \{ a \} = b_1
\end{align}

\section{D operations}

\subsection{SqrtB $\sqrt{B_1} \mapsto D \iff b_1 > 0$}
\begin{align}
\sqrt{B_1} &= \sqrt{\frac{+b_1}{a_1}}\\
  &= \frac{\sqrt{a_1b_1}}{a_1}\\
  &= \frac{x\sqrt{d}}{a_1}    \implies \{ x^2d \} = a_1b_1 \\
  &= \frac{c\sqrt{d}}{a}  \implies \{ a, c \} = gcd\{ a_1, x\}
\end{align}
...
\subsection{Mul $D_1 \times D_2 \mapsto D$}
\begin{align*}
D_1 \times D_2 &= \frac{\pm a_1\sqrt{c_1}}{b_1} \times \frac{\pm a_2\sqrt{c_2}}{b_2}\\
...
\subsection{Inv $1 / D_1 \mapsto D$}
\begin{align*}
1 / D_1 &= \frac{1}{\frac{\pm a_1\sqrt{c_1}}{b_1}} \\
