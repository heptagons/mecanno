...
D_1 &= \frac{\pm b_1 \pm c_1\sqrt{d_1}}{a_1}\\
 &= \frac{\pm b_1 \pm c_1p\sqrt{d}}{a_1}\\
 &\quad \textbf{ where } \{ d \} = p^2d_1 \textbf{ when } p>1 \nonumber \\
 &= \frac{\pm b \pm c\sqrt{d}}{a}\\
 &\quad \textbf{ where } \{ a,b,c \} = \gcd \{ a_1, \pm b_1, c_1p \} \nonumber
\end{align}
...
\sqrt{B_1} &= \sqrt{\frac{+b_1}{a_1}}\\
  ...
  &= \frac{x\sqrt{d}}{a_1}\\
  &\quad \textbf{ where } \{ x^2d \} = a_1b_1 \nonumber \\
  &= \frac{c\sqrt{d}}{a}\\
  &\quad \textbf{ where } \{ a, c \} = gcd\{ a_1, x\} \textbf{ and } \{ b \} = 0 \nonumber
\end{align}

\subsection{InvD $1 / D_1 \mapsto D$}
\begin{align*}
1 / D_1 &= \frac{1}{\frac{\pm b_1 \pm c_1\sqrt{d_1}}{a_1}} \\
