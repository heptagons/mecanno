...
$vertex_X$ & $vertex_Y$ & $\cos(X+Y)$ \\
\hline\endfoot
(1,1,1)[A] & (1,1,1)[A] & $-\frac{1}{2}$\\ %-1/2
(2,2,1)[A] & (1,1,1)[A] & $\frac{1-3\sqrt{5}}{8}$\\ %(1-3√5)/8
(2,2,1)[C] & (1,1,1)[A] & $\frac{7-3\sqrt{5}}{16}$\\ %(7-3√5)/16
(2,2,1)[A] & (2,2,1)[A] & $-\frac{7}{8}$\\ %-7/8
(2,2,1)[A] & (2,2,1)[C] & $-\frac{1}{4}$\\ %-1/4
(2,2,1)[C] & (2,2,1)[C] & $\frac{17}{32}$\\ %17/32
(3,2,2)[A] & (1,1,1)[A] & $-\frac{1+3\sqrt{21}}{16}$\\ %(-1-3√21)/16
(3,2,2)[B] & (1,1,1)[A] & $\frac{3-\sqrt{21}}{8}$\\ %(3√21)/8
(3,2,2)[A] & (2,2,1)[A] & $-\frac{1+3\sqrt{105}}{32}$\\ %(-1-3√105)/32
(3,2,2)[A] & (2,2,1)[C] & $-\frac{7+3\sqrt{105}}{64}$\\ %(-7-3√105)/64
(3,2,2)[B] & (2,2,1)[A] & $\frac{3-\sqrt{105}}{16}$\\ %(3√105)/16
(3,2,2)[B] & (2,2,1)[C] & $\frac{21-\sqrt{105}}{32}$\\ %(21√105)/32
(3,2,2)[A] & (3,2,2)[A] & $-\frac{31}{32}$\\ %-31/32
(3,2,2)[A] & (3,2,2)[B] & $-\frac{3}{4}$\\ %-3/4
(3,2,2)[B] & (3,2,2)[B] & $\frac{1}{8}$\\ %1/8
(3,3,1)[A] & (1,1,1)[A] & $\frac{1-\sqrt{105}}{12}$\\ %(1√105)/12
(3,3,1)[C] & (1,1,1)[A] & $\frac{17-\sqrt{105}}{36}$\\ %(17√105)/36
(3,3,1)[A] & (2,2,1)[A] & $\frac{1-5\sqrt{21}}{24}$\\ %(1-5√21)/24
(3,3,1)[A] & (2,2,1)[C] & $\frac{7-5\sqrt{21}}{48}$\\ %(7-5√21)/48
(3,3,1)[C] & (2,2,1)[A] & $\frac{17-5\sqrt{21}}{72}$\\ %(17-5√21)/72
(3,3,1)[C] & (2,2,1)[C] & $\frac{119-5\sqrt{21}}{144}$\\ %(119-5√21)/144
(3,3,1)[A] & (3,2,2)[A] & $-\frac{1+21\sqrt{5}}{48}$\\ %(-1-21√5)/48
(3,3,1)[A] & (3,2,2)[B] & $\frac{3-7\sqrt{5}}{24}$\\ %(3-7√5)/24
(3,3,1)[C] & (3,2,2)[A] & $-\frac{17+21\sqrt{5}}{144}$\\ %(-17-21√5)/144
(3,3,1)[C] & (3,2,2)[B] & $\frac{51-7\sqrt{5}}{72}$\\ %(51-7√5)/72
(3,3,1)[A] & (3,3,1)[A] & $-\frac{17}{18}$\\ %-17/18
(3,3,1)[A] & (3,3,1)[C] & $-\frac{1}{6}$\\ %-1/6
(3,3,1)[C] & (3,3,1)[C] & $\frac{127}{162}$\\ %127/162
(3,3,2)[A] & (1,1,1)[A] & $\frac{1-2\sqrt{6}}{6}$\\ %(1-2√6)/6
(3,3,2)[C] & (1,1,1)[A] & $\frac{7-4\sqrt{6}}{18}$\\ %(7-4√6)/18
(3,3,2)[A] & (2,2,1)[A] & $\frac{1-2\sqrt{30}}{12}$\\ %(1-2√30)/12
(3,3,2)[A] & (2,2,1)[C] & $\frac{7-2\sqrt{30}}{24}$\\ %(7-2√30)/24
(3,3,2)[C] & (2,2,1)[A] & $\frac{7-4\sqrt{30}}{36}$\\ %(7-4√30)/36
(3,3,2)[C] & (2,2,1)[C] & $\frac{49-4\sqrt{30}}{72}$\\ %(49-4√30)/72
(3,3,2)[A] & (3,2,2)[A] & $-\frac{1+6\sqrt{14}}{24}$\\ %(-1-6√14)/24
(3,3,2)[A] & (3,2,2)[B] & $\frac{3-2\sqrt{14}}{12}$\\ %(3-2√14)/12
(3,3,2)[C] & (3,2,2)[A] & $-\frac{7+12\sqrt{14}}{72}$\\ %(-7-12√14)/72
(3,3,2)[C] & (3,2,2)[B] & $\frac{21-4\sqrt{14}}{36}$\\ %(21-4√14)/36
(3,3,2)[A] & (3,3,1)[A] & $\frac{1-2\sqrt{70}}{18}$\\ %(1-2√70)/18
(3,3,2)[A] & (3,3,1)[C] & $\frac{17-2\sqrt{70}}{54}$\\ %(17-2√70)/54
(3,3,2)[C] & (3,3,1)[A] & $\frac{7-4\sqrt{70}}{54}$\\ %(7-4√70)/54
(3,3,2)[C] & (3,3,1)[C] & $\frac{119-4\sqrt{70}}{162}$\\ %(119-4√70)/162
(3,3,2)[A] & (3,3,2)[A] & $-\frac{7}{9}$\\ %-7/9
(3,3,2)[A] & (3,3,2)[C] & $-\frac{1}{3}$\\ %-1/3
(3,3,2)[C] & (3,3,2)[C] & $\frac{17}{81}$\\ %17/81
\end{longtable}
