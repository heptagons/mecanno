...
\draw[black] (\pX)
-- (\pY) foreach \t in {0,\zz,...,1} { pic [pos=\t] {code={\fill circle[radius=0.07];}}} node[midway,below]{b}
...
\begin{tikzpicture}
\meccanotriangle{ 0}{ 0}{5}{7}{6}{{2/0},{3/1},{4/2},{5/3},{6/4}};
\meccanotriangle{ 4}{ 0}{5}{7}{6}{{1/0},{2/1},{3/2},{4/3},{5/4}};
\meccanotriangle{ 8}{ 0}{5}{7}{6}{{1/1},{2/2},{3/3},{4/4}};
\meccanotriangle{ 0}{-3.5}{5}{7}{6}{{0/1},{1/2},{2/3},{3/4}};
\meccanotriangle{ 4}{-3.5}{5}{7}{6}{{0/2},{1/3},{2/4}};
\meccanotriangle{ 8}{-3.5}{5}{7}{6}{{0/3},{1/4}};
\meccanotriangle{12}{-3.5}{5}{7}{6}{{0/4}};
\end{tikzpicture}
