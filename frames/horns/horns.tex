...
\title{\textbf{Horns frame}}
\author{https://github.com/heptagons/meccano/frames/horns}
\date{}
...
\maketitle
\begin{abstract}
Horns frame is a group of seven meccano\meccanoref strips intended to build polygons.
We found the formula to calculate the internal angles then look for polygons.
With sofware we found hexagons, octagons and dodecagons. We found no pentagons.
\end{abstract}
...
\end{tikzpicture}
\caption{The \textbf{horn frame} has seven strips: Two of length $a$, two of length $b+d$,
