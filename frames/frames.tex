...
$g$ & $T(x,y_1,y_2)$ \\ [0.5ex]
\hline
$g^{++}$ & $T(x, y_1 \geq 0, y_2 \geq 0)$ \\
$g^{+-}$ & $T(x, y_1 \geq 0, y_2 < 0)$ \\
$g^{-+}$ & $T(x, y_1 < 0, y_2 \geq 0)$ \\
$g^{--}$ & $T(x, y_1< 0, y_2 < 0)$ \\
\hline
\end{tabular}
\end{center}
...
(E_x^2 + E_y^2)^{++} &= (x + \delta\cos\phi)^2 + (\delta\sin\phi)^2 \nonumber\\
 ...
 &= x^2 + \delta^2 + \frac{2x\delta o}p\\
(B_xE_x)^{++} &= (\alpha\cos\theta)(x + \delta\cos\phi) \nonumber\\
 &= \frac{\alpha mx}{n} + \frac{\alpha m\delta o}{np}\\
...
& = \sqrt{
\alpha^2
+ \left(x^2 + \delta^2 + \frac{2x\delta o}p\right)
- 2\left(\frac{\alpha mx}{n} + \frac{\alpha m\delta o}{np}\right)
+ 2\left(\frac{\alpha \delta\sqrt{(n^2 - m^2)(p^2 - o^2)}}{np}\right)
}\nonumber\\
%
 &= \sqrt{
\alpha^2 + x^2 + \delta^2 + \frac{2x\delta o}p - \frac{2\alpha mx}n - \frac{2\alpha m\delta o}{np}
+ \frac{2\alpha\delta\sqrt{(n^2-m^2)(p^2-o^2)}}{np}
}\nonumber\\
%
 &= \frac{\sqrt{
n^2p^2(\alpha^2 + x^2 + \delta^2) + 2x\delta on^2p - 2\alpha mxnp^2 - 2\alpha m\delta onp
+ 2\alpha\delta np\sqrt{(n^2-m^2)(p^2-o^2)}
}}{np} \nonumber\\
%
 &= \frac{\sqrt{
n^2p^2(\alpha^2 + x^2 + \delta^2) + 2np(x\delta on - \alpha mxp - \alpha m\delta o)
+ 2np\alpha\delta\sqrt{(n^2-m^2)(p^2-o^2)}
}}{np}
\end{align}
...
\begin{align}
i_1 &= np \\
i_2 &= i_1^2(\alpha^2 + x^2 + \delta^2) + 2i_1(x\delta on - \alpha mxp - \alpha m\delta o)\\
i_3 &= 2i_1\alpha\delta \nonumber\\
i_4 &= (n^2 - m^2)(p^2 - o^2)\\
