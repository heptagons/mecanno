...
\begin{figure}[H]
 ...
 \begin{tikzpicture}
  \begin{scope}[scale=1]
   \begin{scope}[shift={(0,0)}]
    \meccanopentagon{880088}{3}{3pt} %color,length,p
   ...
   \begin{scope}[shift={(7,0)}]
    ...
    \begin{scope}[rotate around={6.1:(1,0)},shift={(0.5,sqrt(-0.25+4)}]
     \meccanoframetrianglex{0}{1}{1}{1} {1}{+2}{3pt}{0}
     \meccanoframetrianglex{1}{2}{1}{2} {0}{+0}{3pt}{0}
    \end{scope}
  ...
  \end{scope}
 \end{tikzpicture}
 \caption{Regular pentagon made rigid with two triangle pairs extended as diagonals.}
\end{figure}
