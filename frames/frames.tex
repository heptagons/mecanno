...
\newcommand{\meccanoframetriangleextra}[3]{
 ...
 \def\ff{#2}
 \def\gg{#3}
 %\def\f{\pgfmathparse{#2}\pgfmathresult}
 %\def\g{\pgfmathparse{#3}\pgfmathresult}
...
\end{lstlisting}
The code is in folder \texttt{github.com/heptagons/meccano/frames}.

\begin{figure}[h]
\centering
\begin{center}
\meccanoframetriangle{1}{1}{1}{0}{2}{3pt}{1.0}{0}{0}(a)\qquad
\meccanoframetriangle{3}{2}{2}{0}{2}{3pt}{0.7}{5}{4}(b)\qquad
\meccanoframetriangle{4}{4}{1}{2}{4}{3pt}{0.5}{0}{0}(c)\qquad
\meccanoframetriangle{7}{5}{3}{0}{2}{3pt}{0.6}{0}{0}(d)
\end{center}
\caption{Triangles with extended fixed distance $\overline{DE}=\sqrt{7}$.}
\end{figure}
